...
{
	DeviceBuffer screenQuadBuffer;
	DeviceBuffer screenQuadIndexBuffer;
	private ResourceLayout layout;
	private ResourceSet _resourceSet;

	private uint FBOShader;
	// Cambiar el array del quad para que las UVs sean correctas
	float[] screenQuadArray = new float[] { 
		// Posiciones X,Y  // UVs
	...
	uint[] screenQuadArrayIndex = new uint[]
	{
